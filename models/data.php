<?php
    ...
    function getListeSec() : array
    {
        return 
        [
            ["DWWM", "Développeur Web et Web Mobile", "12/03/20", 0, "dwwm"],
            ["TSSR", "Technicien Supérieur en Systèmes et Réseau", "20/07/19", 0, "tssr"],
            ["DW", "Designer Web", "15/08/19", 0, "dw"],
            ["DC", "Digital Codeur", "29/09/19", 0, "dc"],
            ["DR", "Digital Repair", "05/10/19", 0, "dr"],
            ["SR", "Serveur(se) en Restauration", "31/08/20", 0, "sr"]
